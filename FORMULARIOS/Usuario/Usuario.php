...
$sql="select  Cod_empleados from empleados";


while ($registro= mysqli_fetch_array($sql)){
	$codigoss=$registro['Cod_empleados'];
	if ($empleados <> $codigoss){
echo "<script>
...
if ($CU=="" Or $U=="" Or $P=="" Or $C=="" Or $empleados==""){
	echo "<script>
...
$consulta="insert into usuario(Cod_Usuario,Usuario,Password,Correo,Cod_rol,Cod_empleados)
 VALUES('$CU','$U','$P','$C','$crol','$empleados')";
...
<td><input type="text" name="usuario" value="<?php echo $usuario?>" size="15" maxlength="15"onKeyPress=" return SoloLetras (event)" onpaste="return false" /></td></tr>

<tr><td><label>Password:</label></td>
<td><input type="Password" id="Password" name="P" value="<?php echo $pass?>" size="20" maxlength="20"/></td></tr>

<tr><td><label>Correo:</label></td>
<td><input type="email"  name="correo" value="<?php echo $correo?>" size="20" maxlength="20"/></td></tr>
