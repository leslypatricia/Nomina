...
<table border="1">
	...
	<?php
$sql="SELECT j.Cod_Jornada,j.Tipo_Jornada,j.Numero_horas,j.Sueldo_Base,
j.Sueldo_Hora,j.Porce_Hora_Extra,ep.Cod_empleados from jornada as j
JOIN empleados as ep on ep.Cod_empleados=j.Cod_empleados
