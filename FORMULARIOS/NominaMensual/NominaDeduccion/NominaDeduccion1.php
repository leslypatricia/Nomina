...
<thead class="text-center" border="60" color="black">
 <th>Código Deducciones</th>
	...
	while($mostrar=mysqli_fetch_array($res)){
		...
		echo "<td><a href='Eliminar.php?CE=".$mostrar['Cod_NominaD']."'><button name='Eliminar' class='boton-eliminar' ><i class='far fa-trash-alt'></a></i></button></td>";
		echo "<td><a href='Actualizar.php?CE=".$mostrar['Cod_NominaD']."'><button name='Actualizar' class='boton-actualizar'><i class='fas fa-edit'></a></i></button></td>";
		echo "</tr>";
