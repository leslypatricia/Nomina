...
<div class="Container">
  ...
  <div class="form-group">
	...
	<!--    
<button name="Insertar"  class="boton_Añadir">Añadir Horas Extras Empleados  <i class="fas fa-plus"></i></button>Datatables-->
...
JOIN empleados as ep on ex.Cod_empleados=ep.Cod_empleados " ;
	...
	while($mostrar=mysqli_fetch_array($res)){
		...
		echo "<td><a href='Eliminar.php?CE=".$mostrar['Cod_HExtra']."'><button name='Eliminar' class='boton-eliminar' ><i class='far fa-trash-alt'></a></i></button></td>";
		echo "<td><a href='Actualizar.php?CE=".$mostrar['Cod_HExtra']."'><button name='Actualizar' class='boton-actualizar'><i class='fas fa-edit'></a></i></button></td>";
		echo "</tr>";
