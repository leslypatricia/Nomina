...
include("../conexion.php");
 ...
 $registros=mysqli_query($conexion,"select Cod_empleados,Identidad,Primer_Nombre,Segundo_Nombre,Primer_Apellido,Segundo_Apellido,Sueldo_base FROM  empleados WHERE Cod_FormaPago=2");
...
$sql="insert into 
nomina_quincenal(Cod_Nomina,Cod_empleados,Identidad,Primer_Nombre,Segundo_Nombre,Primer_Apellido,Segundo_Apellido,Sueldo_base,Fecha_Generada)
    ...
    <tr class="Estilo-tabla">
       <td>Código Nómina</td> 
          ...
          <tr>
				...
				<tr>
				<td><button name="Crear"  class="boton_Añadir">Crear Nomina Quincenal<i class="fas fa-plus"></i></button></td>
				</tr>
...
<thead class="text-center" border="60" color="black">
    ...
    <?php
		$fcha = date("Y-m-d");
		$sql="SELECT * FROM nomina_quincenal";
