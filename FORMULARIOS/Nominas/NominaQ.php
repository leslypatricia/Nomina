...
include("../conexion.php");
 ...
 $registros=mysqli_query($conexion,"select Cod_empleados,Identidad,Primer_Nombre,Segundo_Nombre,Primer_Apellido,Segundo_Apellido,Sueldo_base FROM  empleados WHERE FormaPago='Quincenal'");
...
nominageneral(Cod_Nomina,Cod_empleados,Identidad,Primer_Nombre,Segundo_Nombre,Primer_Apellido,Segundo_Apellido,Sueldo_base,FormaPago,Fecha_Generada)
 VALUES('$Codigo','$CE','$ID','$PN','$SN','$PA','$SA','$sueldo','$FormaP','2020-12-15')";
 ///aqui*******************************************************************->
...
<div class="Container">
  ...
  <div class="form-group">
	 ...
	 <center>
	 <h1>Nómina de la Primer Quincena del Mes</h1>
	 </center>
	 <center>
      ...
      <table border="1" class="color-Tabla" align="left">
          ...
          <tr class="Estilo-tabla"align="regth" ><td>Fecha de Elaboración de Nomina</td></tr>
		    <?php $fcha = date("Y-m-d");?>
    ...
    <tr class="Estilo-tabla">
       <td>Código Nómina</td> 
          ...
          <tr>
				...
				<tr>
				<td><button name="Crear"  class="boton_A�adir">Crear Nómina Quincenal<i class="fas fa-plus"></i></button></td>
				</tr>
